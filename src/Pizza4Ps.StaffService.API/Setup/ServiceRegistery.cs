using Pizza4Ps.StaffService.API.DependencyInjection.Extentions;
using Pizza4Ps.StaffService.Application.DependencyInjection.Extentions;
using Pizza4Ps.StaffService.Domain.DependencyInjection.Extentions;
using Pizza4Ps.StaffService.Persistence.DependencyInjection.Extentions;
...
namespace Pizza4Ps.StaffService.API.Setup
{
    public static class ServiceRegistery
    {
        ...
        private static void RegisterApiServices(IServiceCollection services)
        {
            ...
            services.AddServiceStaffClient();
        }
